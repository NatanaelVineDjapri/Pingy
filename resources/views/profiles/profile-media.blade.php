        ...
        <section class="mytweets">
            ...
            @foreach($tweetImage as $index =>$image)
                    <div class="tweet-image">
                        <a href="{{asset('/storage/'.$image->tweetImage)}}" target="_blank"><img src="{{ asset('storage/' . $image->tweetImage) }}" alt="Tweet image" style="width: 200px; height:200px;border-radius: 10px; margin-top: 10px; object-fit:cover ; "></a>
                    </div>
                    @if(($index + 1) % 3 ===0)
