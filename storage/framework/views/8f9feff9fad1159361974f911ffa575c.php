...
<?php $__env->startSection('content'); ?>
    <div class="message-container">
        <div class="message-box">
            <form
                action="<?php echo e(route('inboxmessage')); ?>"
                method="GET"
                class="tweet-form"
                    ...
                    <div class="message-item">
                        <div class="tweet-header">
                            <?php if($contact->avatar): ?>
                                <img
                                    src="<?php echo e(asset('storage/' . $contact->avatar)); ?>"
                                    class="avatar"
                                />
                            <?php else: ?>
                                <img
    ...
    <div class="personal-container">
                    ...
                    <div class="message-item">
                        <div class="message-header-right">
                            <div class="header-profile">
                                <form
                                    action="<?php echo e(route('deletemessage', ['user' => auth()->user()->id, 'message' => $message->id])); ?>"
                                    method="POST"
        ...
        <div class="input">
            <form
                action="<?php echo e(route('postmessage', $user->id)); ?>"
                method="POST"
                class="message-form"
            >
                <?php echo csrf_field(); ?>
