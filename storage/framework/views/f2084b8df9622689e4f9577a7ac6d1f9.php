                ...
                <div class="tweet-item">
                    <div class="tweet-header">
                        <?php if($notif->user->avatar): ?>
                            <img
                                src="<?php echo e(asset('storage/' . $notif->user->avatar)); ?>"
                                class="avatar"
                            />
                        <?php else: ?>
                        ...
                        <div class="packs-name">
                            ...
                            <p class="username">
                                <?php echo e('@' . $notif->user->username); ?> -
                    ...
                    <div class="tweet-body">
                        <?php if($notif->body): ?>
                            ...
                            <form
                                action="<?php echo e(route('deletenotifcomment', ['user' => auth()->id(), 'comment' => $notif->id])); ?>"
                                method="POST"
                            >
                                <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            ...
                            <form
                                action="<?php echo e(route('deletenotiflike', ['user' => auth()->id(), 'like' => $notif->id])); ?>"
                                method="POST"
                            >
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                        ...
                        <?php if($notif->tweet->tweetImage): ?>
                            <div class="tweet-image">
                                <img
                                    src="<?php echo e(asset('storage/' . $notif->tweet->tweetImage)); ?>"
                                    alt="Tweet image"
                                    style="
                                        width: 100%;
                                        max-width: 675px;
                        ...
                        <a href="<?php echo e(route('showcomment', $notif->tweet->id)); ?>">
                            See Details Tweet
                        </a>
                    </div>
                </div>
