        ...
        <div class="middlecontainer">
            <section class="headsec">
                <div class="header-title">
                    <a href="<?php echo e(url()->previous()); ?>" class="item-icon">
            ...
            <section class="twitterprofile">
                <div class="headerprofileimage">
                    <?php if($user->banner): ?>
                        <img
                            src="<?php echo e(asset('storage/' . $user->banner)); ?>"
                            alt="header"
                            id="headerimage"
                            class="header-a"
                        />
                    <?php else: ?>
                        <img
                            src="<?php echo e(asset('image/banner.jpg')); ?>"
                            alt="header default"
                            id="headerimage"
                            class="header-b"
                        />
                    ...
                    <?php else: ?>
                        <img
                            src="<?php echo e(asset('image/profilepicture.jpg')); ?>"
                            alt="profile pic"
                            id="profilepic"
                        />
                    <?php endif; ?>
                    <div class="editprofile">
                        <?php if(Auth::id() == $user->id): ?>
                            <a href="<?php echo e(route('editprofile', $user->id)); ?>" class="follow-btn">
                                Edit Profile
                            </a>
                        <?php else: ?>
                ...
                <div class="bio">
                    ...
                    <span>
                        ...
                        Joined <?php echo e($user->created_at->format('F Y')); ?>

                    </span>
                    <div class="nawa">
                        <div>
                            <a href="<?php echo e(route('showfollow', $user->id)); ?>">
                                <?php echo e($user->following_count); ?>
                        ...
                        <div>
                            <a href="<?php echo e(route('showfollow', $user->id)); ?>">
                                <?php echo e($user->followers_count); ?>
                    ...
                    <div class="tweet">
                        ...
                        <div class="tweetbody">
                            <div class="packs-name">
                                ...
                                <p class="username">
                                    <?php echo e('@' . $tweet->user->username); ?> -
                            ...
                            <?php if($tweet->tweetImage): ?>
                                <div class="tweet-image">
                                    <img
                                        src="<?php echo e(asset('storage/' . $tweet->tweetImage)); ?>"
                                        alt="Tweet image"
                                        style="
                                            max-width: 80%;
                                            border-radius: 10px;
                            ...
                            <ul class="retweeticons">
                                ...
                                <li>
                                    ...
                                    <form
                                        action="<?php echo e(route('postretweet', $tweet->id)); ?>"
                                        method="POST"
                                    >
                                        <?php echo csrf_field(); ?>
                                        <?php if($retweet): ?>
                                ...
                                <li>
                                    ...
                                    <form
                                        action="<?php echo e(route('liketweet', $tweet->id)); ?>"
                                        method="POST"
                                    >
                                        <?php echo csrf_field(); ?>
                                        <?php if($liked): ?>
                                ...
                                <li>
                                    ...
                                    <form
                                        action="<?php echo e(route('postbookmarks', $tweet->id)); ?>"
                                        method="POST"
                                    >
                                        <?php echo csrf_field(); ?>
                                        <?php if($bookmarked): ?>
                                ...
                                <?php if(auth()->id() === $tweet->user->id): ?>
                                    <li>
                                        <form
                                            action="<?php echo e(route('deletetweet', $tweet->id)); ?>"
                                            method="POST"
                                    ...
                                    <li>
                                        <a
                                            href="<?php echo e(route('edittweet', $tweet->id)); ?>"
                                            class="edit-btn"
                                        >
