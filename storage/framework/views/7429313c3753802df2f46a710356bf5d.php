                    ...
                    <div class="tweetbody">
                        ...
                        <li> 
                            ...
                            <form action="<?php echo e(route('postbookmarks', $tweet->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php if($bookmarked): ?>
                                    <button type="submit" class="delete-btn"><ion-icon name="bookmark"></ion-icon></button>
                                <?php else: ?>
                                    <button type="submit" class="delete-btn"><ion-icon name="bookmark-outline"></ion-icon></button>
                                <?php endif; ?>
                            </form>
                        </li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\New folder\htdocs\ProjectUAS\Pingy\resources\views/profiles/profile-show.blade.php ENDPATH**/ ?>