...
<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <div class="tweet-container">
            <div class="tweet-box">
                <form
                    action="<?php echo e(route('posttweet')); ?>"
                    method="POST"
...
<?php echo e(old('body')); ?></textarea
                    ...
                    <div class="tweet-actions">
                        <label for="tweetImage" class="upload-label">
                ...
                <?php if(session('previewPath')): ?>
                    <div class="image-preview">
                        <img
                            src="<?php echo e(asset('storage/' . session('previewPath'))); ?>"
                            alt="Preview"
                            class="tweet-image"
                        />
                    </div>
                    ...
                    <div class="tweet-item">
                        <div class="tweet-header">
                            <?php if($tweet->user->avatar): ?>
                                <img
                                    src="<?php echo e(asset('storage/' . $tweet->user->avatar)); ?>"
                                    class="avatar"
                                />
                            <?php else: ?>
                                <img
                            ...
                            <div class="packs-name">
                                <a href="<?php echo e(route('showprofile', $tweet->user->id)); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\UAS_BACKEND\pingy\resources\views/homes/home-following.blade.php ENDPATH**/ ?>